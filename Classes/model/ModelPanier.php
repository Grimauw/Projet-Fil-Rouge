...
class ModelProduit
{
  ...
  public  function ajoutProduit($nom, $logo, $ref, $description, $quantite, $prix, $photo, $id_categorie, $id_marque)
  {
    $idcon = connexion();
    $requete = $idcon->prepare("
      INSERT INTO produit VALUES (null, :nom, :logo, :ref, :description, :quantite, :prix, :photo, :id_categorie, :id_marque)
    ");
