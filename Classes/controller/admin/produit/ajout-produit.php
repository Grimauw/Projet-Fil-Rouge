...
<body>
  ...
  if (isset($_POST['ajout'])) {
    ...
    if ($data && ($upload['uploadOk']) && ($produit->ajoutProduit($_POST['nom'], $_POST['reference'], $_POST['description'], $_POST['quantite'], $_POST['prix'], $_FILES['fichier']['name'], $_POST['id_categorie'], $_POST['id_marque']))) {
      ...
      ViewTemplateAdmin::alert("success", "Produit ajouté avec succès", "liste-produit.php");
    } else {
      echo "<h1>" . $upload['errors'] . "</h1>";
      ViewTemplateAdmin::alert("danger", "Erreur lors de l'ajout", "ajout-produit.php");
    }
  } else {
