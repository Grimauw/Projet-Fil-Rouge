...
<body>
  ...
  if (isset($_POST['ajout'])) {
    ...
    $role = new ModelRole();
    if ($data && ($role->ajoutRole($_POST['nom']))) {
      ...
      ViewTemplateAdmin::alert("success", "Rôle ajouté avec succès", "liste-role.php");
    } else {
      ViewTemplateAdmin::alert("danger", "Erreur lors de l'ajout", "ajout-role.php");
    }
  } else {
    ViewRole::ajoutRole();
  }
