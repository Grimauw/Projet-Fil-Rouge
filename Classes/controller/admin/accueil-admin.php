...
if (isset($_SESSION['id']) && ($_SESSION['role'] === 'admin') ) {
  ...
  $salutation.= '<a href="deconnexion.php">Déconnexion</a>'  ;
}
...
<header>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="profil-client.php">Produit <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="profil-client.php">Commande <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="profil-client.php">Profil <span class="sr-only">(current)</span></a>
      </li>
