...
<head>
  ...
  <title>Suppression de la Marque</title>
</head>
...
<body>
  ...
  if (isset($_GET['id'])) {
    ...
    if ($marque->voirMarque($_GET['id'])) {
      if ($marque->suppMarque($_GET['id'])) {
        ViewTemplateAdmin::alert("success", "Catégorie supprimée avec succès !", "liste-marque.php");

        // header('Location: connexion-client.php');
        exit;
      } else {
        ViewTemplateAdmin::alert("danger", "Echec de la suppression !", "voir-marque.php");
      }
    } 
  }
